 ...
 */
class TheInfiniTimeTestController extends Controller {
 ...
 */
	public function setUp() {
		...
		$this->InfiniTime->request->webroot = '';
 ...
 */
	public function testVarious() {
		...
		$this->assertEquals("(Item.created >= '2009-10-30 00:00:00') AND (Item.created <= '2009-10-30 23:59:59')", $result);

		$result = $this->InfiniTime->format('Y-m-d H:i:s', '2010-10-24 14:15:10');
		$this->assertEquals('2010-10-24 15:15:10', $result);
		...
		$this->assertEquals('maandag, 15 november 2010 16:14', $result);

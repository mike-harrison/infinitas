...
class ScopedNumberTreeTest extends CakeTestCase {
	public $fixtures = array(
		'plugin.libs.scoped_counter_number_tree',
	...
	public function testAddingNodes() {
		...
		$this->ScopedNumberTree->create();
		$this->assertTrue((bool)$this->ScopedNumberTree->save($data));
		...
		$this->assertEquals($expected, array_values($this->ScopedNumberTree->generateTreeList(array('ScopedNumberTree.category_id' => 'cat-a'))));
	...
	public function testMovingNodes() {
		...
		$this->assertTrue((bool)$this->ScopedNumberTree->removefromtree('cat-a-1-2-3'));
	...
	function testCounterCache() {
		...
		$this->assertTrue((bool)$this->ScopedCounterNumberTree->save($data));
